...
public class QuizRunner { //comment for updating on GitHub
    public static void main(String[] args) {
        ...
        CheckBox question3 = new CheckBox("Which animal(s) cannot fly?", new ArrayList<>(Arrays.asList("dog", "cat", "bird", "lizard")), new ArrayList<>(Arrays.asList("dog", "cat", "lizard")), new ArrayList<String>(Arrays.asList("bird")));
        quiz.add(question1);
        quiz.add(question2);
        quiz.add(question3);
